...
void mlx_player(t_data *game, char *s[SPRITE_FRAMES]) 
{
	 for (int i = 0; i < 37; i++) 
	{
        ...
        handle_error(game, i);
        game->walls->addr_player[i] = (int *)mlx_get_data_addr(game->walls->player[i], 
                                                               &game->walls->bpp_player[i], 
...
void load_textures(t_data *game) 
{
    char *s[SPRITE_FRAMES] = {
        ...
        "textures/player/13.xpm", "textures/player/14.xpm", "textures/player/15.xpm", 
        "textures/player/16.xpm", "textures/player/17.xpm", "textures/player/18.xpm", 
        "textures/player/19.xpm", "textures/player/20.xpm", "textures/player/21.xpm", 
        "textures/player/22.xpm", "textures/player/23.xpm", "textures/player/24.xpm", 
        "textures/player/25.xpm", "textures/player/26.xpm", "textures/player/27.xpm", 
        "textures/player/28.xpm", "textures/player/29.xpm", "textures/player/30.xpm", 
        "textures/player/31.xpm", "textures/player/32.xpm", "textures/player/33.xpm", 
        "textures/player/34.xpm", "textures/player/35.xpm", "textures/player/36.xpm", 
        "textures/player/37.xpm", "textures/player/38.xpm", "textures/player/39.xpm", 
